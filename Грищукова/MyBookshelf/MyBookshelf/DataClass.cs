...
namespace MyBookshelf
{
    class DataClass
    {
        ...
        public void CreateStrConnection()
        {
            ...
            connectionStr.Server = "парольk403";
        ...
        internal void AddBook(string text1, string text2, string text3, int v)
        {
